...
internal static partial class Constants
{
    public static class Validators
    {
        public static class UserInterface
        {
            ...
            private static readonly string s_componentOrder = Path.Combine(s_windows, "ComponentOrder");
            ...
            public static readonly string Status = Path.Combine(s_userInterface, "Status");
            ...
            public static readonly string ValidatorView = Path.Combine(s_userInterface, "Validator View");
