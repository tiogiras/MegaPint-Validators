        ...
        new Data(
            ...
            new List <Data>
            {
                new(
                    ...
                    "SettingPriority",
                    $"Struct in {_ValidatableMonoBehaviour}",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB0),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.BeforeValidation()",
                    "BeforeValidation()",
                    "protected virtual void",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB1),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.DefaultImports()",
                    "DefaultImports()",
                    ...
                    DataKey.VMB2),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.GetImportedSettings()",
                    "GetImportedSettings()",
                    "public List<ValidatorSettings>",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB3),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.ImportSetting()",
                    "ImportSetting()",
                    "public void : (ValidatorSettings)",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB4),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.RemoveImportedSetting()",
                    ...
                    DataKey.VMB5),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.Requirements()",
                    "Requirements()",
                    "public List <ScriptableValidationRequirement> : (bool)",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB6),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.SetRequirements()",
                    "SetRequirements()",
                    "protected void : (List <ScriptableValidationRequirement>)",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB7),
                new(
                    $"<link={DataKey.VMB}>{_ValidatableMonoBehaviour}</link>.Validate()",
                    "Validate()",
                    "public ValidationState : (out List <ValidationError>)",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB8),
                new(
                ...
                new(
                    ...
                    "defaultSettings",
                    "Type of List <ValidatorSettings>",
                    _ValidatableMonoBehaviourAssembly,
                    1,
                    DataKey.VMB10),
                new(
